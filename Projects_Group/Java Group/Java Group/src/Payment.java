...
class Payment {
    ...
    static boolean payByUpi(int value, String pswd) {
        ...
        while (true) {
            if (tries == 0) {
                System.out.println(RED+"                  PAYMENT DECLINED!"+RESET);
                return false;
            }
            ...
            if (passcheck.equalsIgnoreCase(pswd)) {
                while (true) {
                    System.out.print("                  ENTER 1 FOR CONFIRM PAYMENT OF : " + value);
                    int n = sc.nextInt();
                    if (n == 1) {
                        ...
                        System.out.println(CYAN+"                  ENTER VALID NUMBER"+RESET);
                    }
                }
            } else {
        ...
        while (true) {
            ...
            if (temp1 == 1 && temp2 == 1 && temp3 == 1 && passcheck.equalsIgnoreCase(pswd)) {
                while (true) {
                    ...
                    int n = sc.nextInt();
                    if (n == 1) {
                        System.out.println(RED+"                  PAYMENT SUCCESSFUL"+RESET);
                        return true;
                    } else {
                        System.out.println(RED+"                  INVALID NUMBER"+RESET);
